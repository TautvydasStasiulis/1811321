############################################################
################### Pasiruošimas darbui ####################
## P.S Tai yra projektas, o ne tik duomenų atsisiuntimas ### 
############################################################
...
###########################################################
################# Įmonių palygnimo grafikai ###############
###########################################################
  Imoniu_palyginimas<-Visas
   
  #Šita eilutė naudojama tuomet, kai norima subsetint laikotarpį nuo kurio daromas palyginimas.
